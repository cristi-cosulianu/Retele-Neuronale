# Urmatorele laboratoare de la aceasta materie vor merge intr-o directie un pic diferita fata de curs. Ne propunem in acest laborator sa cream doua programe care sa interactioneze cu o baza de date. 

# Primul program add_files.py va primi ca parametru o locatie in care se afla fisiere. Pentru fiecare fisier din aceasta locatie se vor adauga:
